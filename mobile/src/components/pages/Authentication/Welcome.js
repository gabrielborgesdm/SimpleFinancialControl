...
const { flex1, h1, h3, h4, textCenter, mt5, textUnderline, bgYellow, flexGrow1, textBold, fullWidthImage, minimalistInputGroup, buttonMinimalist, textDarkGrey, p2, mx1, my5 } = styles
        ...
        <LinearGradient start={{x: 0, y: 0}} end={{x: 0, y: 2}} colors={[ lightBlue, lightGreen]} style={[flex1]}>
            ...
            <View style={[minimalistInputGroup]}>
                <TouchableOpacity onPress={this.navigateToSignUp} style={[ buttonMinimalist, bgYellow ]}>
                    <Text style={[textDarkGrey, textBold]}>{translate("CREATE_ACCOUNT")}</Text>
                </TouchableOpacity>
            </View>
            <View style={[minimalistInputGroup], {justifyContent: "center", alignItems: "center", paddingVertical: 25}}>
                <Text style={[textDarkGrey, h3]}>Já é um membro?</Text>
                <TouchableOpacity>
                    <Text style={[textDarkGrey, h3, textBold, textUnderline]}>Faça Login</Text>
                </TouchableOpacity>
            </View>
        </LinearGradient>
    )
